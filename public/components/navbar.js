export const navBar = ()=>{
    ...
    const routes = [
        {link:"http://127.0.0.1:5500/public/index.html", name:"Home"},
        {link:"http://127.0.0.1:5500/public/pages/ingredientes/ingredientes.html", name:"Ingredientes"},
        {link:"http://127.0.0.1:5500/public/pages/recetas/recetas.html", name:"Recetas"}
    ]
    return `
